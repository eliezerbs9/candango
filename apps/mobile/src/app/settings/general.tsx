 ...
 * plan badge, workspace ID + Save. Logo upload is handled on the web (no native
 * image picker bundled) — shown as an intentional read-only logo.
 */
        ...
        <ScrollView style={styles.screen} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <Card style={styles.logoCard}>
            ...
            <View style={styles.logoText}>
              ...
              <Text style={styles.hint}>Upload or change the logo on the web app.</Text>
            </View>
          </Card>
